function create_dict_HR_short(root,folderName,T1,T2)
...
dict_db3=[phi_coefs_db4,coefs_db4];
save( [root '\dict_db3_' num2str(L1) '.mat'] ,'dict_db3')
...
dict_sym3=[phi_coefs_sym1,coefs_sym1];
save([root '\dict_sym3_' num2str(L1) '.mat'],'dict_sym3')
clear coefs phi_coefs phi psi out1
